...
#define MCCONF_BOOST_ENABLED			false // Enable Motor Boost current.
#endif
...
#define MCCONF_MAX_BOOST_TIME			10.0 // Maximum time in seconds for the additional boost current
#endif
